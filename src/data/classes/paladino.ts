...
const PALADINO: ClassDescription = {
  ...
  abilities: [
    ...
    },
    {
      ...
      text:
        'No 5º nível, escolha entre égide sagrada e montaria sagrada (Tormenta 20 pág 84). Uma vez feita, esta escolha não pode ser mudada.',
      nivel: 5,
    },
    {
