...
const MINOR_DEITIES: { name: string; statusDivino: number }[] = [
  ...
  { name: 'Garanaam', statusDivino: 2 },
  { name: 'Garth', statusDivino: 2 },
  { name: 'Goharom', statusDivino: 2 },
  { name: 'Granto', statusDivino: 2 },
  { name: 'Gratissa', statusDivino: 2 },
  { name: 'Gwendolynn', statusDivino: 3 },
  { name: 'Hippion', statusDivino: 3 },
