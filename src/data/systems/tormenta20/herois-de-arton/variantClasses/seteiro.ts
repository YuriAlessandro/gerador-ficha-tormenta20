...
const SETEIRO: VariantClassOverrides = {
  ...
  abilities: [
    ...
    {
      name: 'Sentinela',
      text: 'No 15º nível, uma vez por rodada, quando uma criatura sob efeito de sua Marca da Presa acerta um ataque contra um aliado, você pode gastar 1 PM para fazer um ataque contra essa criatura.',
      nivel: 15,
    },
    {
      name: 'Mestre do Disparo',
      text: 'No 20º nível, você pode usar sua Marca da Presa como uma ação livre. Além disso, uma vez por rodada, quando faz um ataque com um arco ou besta contra um alvo de sua Marca da Presa, você pode fazer um ataque adicional contra ele.',
      nivel: 20,
    },
  ],
};
