...
import AGRICULTOR_SAMBUR from './agricultor-sambur';
import AMAZONA_DE_HIPPION from './amazona-de-hippion';
import AMOQUE_PURPURA from './amoque-purpura';
import ANAO_DE_ARMAS from './anao-de-armas';
import ANDARILHO_UBANERI from './andarilho-ubaneri';
import APRENDIZ_DE_DRAGOEIRO from './aprendiz-de-dragoeiro';
...
import TAMALU from './tamalu';
import TOCADO_PELA_DAMA_ALTIVA from './tocado-pela-dama-altiva';
...
import UM_COM_OS_KAMI from './um-com-os-kami';
