    ...
    system: {
      atributos: {
        for: {
          value: 0,
          bonus: 0,
          base: sheet.atributos.Força.value,
          racial: 0,
        },
        des: {
          value: 0,
          bonus: 0,
          base: sheet.atributos.Destreza.value,
          racial: 0,
        },
        con: {
          value: 0,
          bonus: 0,
          base: sheet.atributos.Constituição.value,
          racial: 0,
        },
        int: {
          value: 0,
          bonus: 0,
          base: sheet.atributos.Inteligência.value,
          racial: 0,
        },
        sab: {
          value: 0,
          bonus: 0,
          base: sheet.atributos.Sabedoria.value,
          racial: 0,
        },
        car: {
          value: 0,
          bonus: 0,
          base: sheet.atributos.Carisma.value,
          racial: 0,
        },
      },
      attributes: {
        ...
        carga: {
          value: 10 + sheet.atributos.Força.value * 2,
          max: (10 + sheet.atributos.Força.value * 2) * 2,
          atributo: 'for',
          base: 10 + sheet.atributos.Força.value * 2,
          bonus: [],
          pct: 0,
          encumbered: false,
        },
