    ...
    <div style={{ padding: '0 30px' }}>
      ...
      <ul>
        ...
        <li>
          ...
          (os nomes usados foram os do escudo do mestre). Nome de Osteon é
          baseado em uma raça &quot;anterior&quot;, ou seja, a raça do
          personagem antes dele morrer.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          Habilidades de raça ou classe que garantam modificações de atributo
        ...
        <li>
          Suporte as seguintes raças: Anão, Dahllan, Elfo, Goblin, Golem,
          Humano, Hynne, Kliren, Lefeu, Medusa, Minotauro, Osteon, Qareen,
          Sereia, Sílfide, Suraggel e Trog.
        </li>
      </ul>
    </div>
  );
