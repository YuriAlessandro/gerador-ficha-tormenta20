            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    setNewAttack({ ...newAttack, attackBonus: e.target.value })
                  }
                  placeholder='0'
                  helperText={`Padrão: +${
                    threat.combatStats?.attackValue || '?'
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={(e) =>
                    setNewAttack({ ...newAttack, bonusDamage: e.target.value })
                  }
                  placeholder='0'
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={4}>
            <Paper variant='outlined' sx={{ p: 2 }}>
              ...
              <Typography variant='body2' color='text.secondary'>
                Valor calculado pelo sistema (+{combatStats?.attackValue || '?'}
