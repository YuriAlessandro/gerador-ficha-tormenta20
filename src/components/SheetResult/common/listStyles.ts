// Vocabulário visual das listas da ficha (Poderes, Magias).
//
// sx em nível de módulo: a ficha pode ter dezenas de itens e cada objeto inline
// força o emotion a re-serializar o estilo.
//
// Nasceu em `PowersTab/powersTabStyles.ts` e subiu pra cá quando a aba de Magias
// passou a precisar do mesmo vocabulário — três cópias do mesmo `GROUP_HEADER_SX`
// era o caminho pra elas divergirem em silêncio.
 ...
 *
 * Sem `noWrap`/ellipsis de propósito: nomes em PT-BR são longos e truncá-los
 * esconde justamente o que diferencia um item do outro.
 */
 ...
 * comeria três linhas da tela antes do primeiro item aparecer.
 *
