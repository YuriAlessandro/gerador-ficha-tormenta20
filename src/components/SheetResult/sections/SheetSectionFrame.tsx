...
export interface SheetSectionFrameProps {
  ...
  /** Título escolhido pelo usuário; sem ele, o `defaultTitle` da seção. */
  title?: string;
  /** Ícone antes do título (escolhido no editor de layout), já renderizado. */
...
const SheetSectionFrame: React.FC<SheetSectionFrameProps> = ({
  ...
  const content = (
    <>
      ...
      {node.withTitle && (
        <BookTitle color={titleColor} icon={titleIcon}>
