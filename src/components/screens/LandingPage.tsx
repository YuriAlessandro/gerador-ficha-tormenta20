    ...
    >
      ...
      >
        <div id='presentation'>
          ...
          <p>
            <strong>Fichas de Nimb</strong> é um gerador de fichas para o
            sistema Tormenta 20. Com ele, é possível gerar fichas de quaisquer
            raças e classes, e ter sua ficha montada facilmente. Todos as
            características de uma ficha de Tormenta 20 serão gerados:
