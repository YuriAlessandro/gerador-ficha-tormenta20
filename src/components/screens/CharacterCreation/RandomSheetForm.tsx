...
const RandomSheetForm: React.FC<RandomSheetFormProps> = ({
  isDarkMode,
  selectedOptions,
        ...
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          ...
          >
            ...
            <Tooltip
              title={
                <span>
                  <strong>Qualquer divindade:</strong> sempre escolhe uma
                  divindade permitida pela classe.
                  <br />
                  <br />
                  <strong>Aleatório:</strong> pode gerar um personagem devoto ou
                  não devoto aleatoriamente.
                </span>
              }
              arrow
              placement='top'
...
export default RandomSheetForm;
