...
const BARBARO = {
  ...
  periciasrestantes: {
    qtd: 4,
    list: [PERICIAS.ADESTRAMENTO, PERICIAS.ATLETISMO, PERICIAS.CAVALGAR, PERICIAS.INICIATIVA, PERICIAS.INTIMIDACAO, PERICIAS.OFICIO, PERICIAS.PERCEPCAO, PERICIAS.PONTARIA, PERICIAS.SOBREVIVENCIA, PERICIAS.VONTADE],
  },
