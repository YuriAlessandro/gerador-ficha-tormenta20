...
const CAVALEIRO = {
  ...
  periciasrestantes: {
    qtd: 2,
    list: [PERICIAS.ADESTRAMENTO, PERICIAS.ATLETISMO, PERICIAS.CAVALGAR, PERICIAS.DIPLOMACIA, PERICIAS.GUERRA, PERICIAS.INICIATIVA, PERICIAS.INTIMIDACAO, PERICIAS.NOBREZA, PERICIAS.PERCEPCAO, PERICIAS.VONTADE],
  },
