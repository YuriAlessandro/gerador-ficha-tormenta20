...
const PALADINO = {
  ...
  periciasrestantes: {
    qtd: 2,
    list: [PERICIAS.ADESTRAMENTO, PERICIAS.ATLETISMO, PERICIAS.CAVALGAR, PERICIAS.CURA, PERICIAS.DIPLOMACIA, PERICIAS.FORTITUDE, PERICIAS.GUERRA, PERICIAS.INICIATIVA, PERICIAS.INTUICAO, PERICIAS.NOBREZA, PERICIAS.PERCEPCAO, PERICIAS.RELIGIAO],
  },
