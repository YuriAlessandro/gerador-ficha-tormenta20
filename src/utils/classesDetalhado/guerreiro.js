...
const GUERREIRO = {
    ...
    periciasrestantes: {
        qtd: 2,
        list: [PERICIAS.ADESTRAMENTO, PERICIAS.ATLETISMO, PERICIAS.CAVALGAR, PERICIAS.GUERRA, PERICIAS.INICIATIVA, PERICIAS.INTIMIDACAO, PERICIAS.LUTA, PERICIAS.OFICIO, PERICIAS.PERCEPCAO, PERICIAS.PONTARIA, PERICIAS.REFLEXOS]
    },
