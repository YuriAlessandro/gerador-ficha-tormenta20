...
const LUTADOR = {
    ...
    periciasrestantes: {
        qtd: 4,
        list: [PERICIAS.ACROBACIA, PERICIAS.ADESTRAMENTO, PERICIAS.ATLETISMO, PERICIAS.ENGANACAO, PERICIAS.FURTIVIDADE, PERICIAS.INICIATIVA, PERICIAS.INTIMIDACAO, PERICIAS.OFICIO, PERICIAS.PERCEPCAO, PERICIAS.PONTARIA, PERICIAS.REFLEXOS]
    },
