...
const NOBRE = {
    ...
    periciasrestantes: {
        qtd: 4,
        list: [PERICIAS.ADESTRAMENTO, PERICIAS.ATUACAO, PERICIAS.CAVALGAR, PERICIAS.CONHECIMENTO, PERICIAS.DIPLOMACIA, PERICIAS.ENGANACAO, PERICIAS.FORTITUDE, PERICIAS.GUERRA, PERICIAS.INICIATIVA, PERICIAS.INTIMIDACAO, PERICIAS.INTUICAO, PERICIAS.INVESTIGACAO, PERICIAS.JOGATINA, PERICIAS.LUTA, PERICIAS.NOBREZA, PERICIAS.OFICIO, PERICIAS.PERCEPCAO, PERICIAS.PONTARIA]
    },
