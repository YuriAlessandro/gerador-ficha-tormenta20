...
const INVENTOR = {
  ...
  periciasrestantes: {
    qtd: 4,
    list: [PERICIAS.CONHECIMENTO, PERICIAS.CURA, PERICIAS.DIPLOMACIA, PERICIAS.FORTITUDE, PERICIAS.INICIATIVA, PERICIAS.INVESTIGACAO, PERICIAS.LUTA, PERICIAS.MISTICISMO, PERICIAS.OFICIO, PERICIAS.PILOTAGEM, PERICIAS.PONTARIA, PERICIAS.PERCEPCAO],
  },
