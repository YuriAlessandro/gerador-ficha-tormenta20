...
export type SheetBuilderStateRaceHumanVersatileChoice =
  | SheetBuilderStateRaceHumanVersatileChoiceSkill
  | SheetBuilderStateRaceHumanVersatileChoicePower;
...
export type SheetBuilderStateRace<
  T = SheetBuilderStateRaceHuman | SheetBuilderStateRaceDwarf
> = {
  attributeModifiers: Partial<Attributes>;
} & T;

export type SheetBuilderStateRole<
  T = SheetBuilderStateRoleWarrior | SerializedArcanist
> = {
...
export type SheetBuilderStateOrigin<
  T = SerializedAnimalsFriend | SerializedAcolyte
> = {
  name: OriginName;
