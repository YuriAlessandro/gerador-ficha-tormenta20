...
export const HomebrewClassContent =
  undefined as unknown as HomebrewClassContent;
...
export type HomebrewPowerPackContent = any;
export const HomebrewPowerPackContent =
  undefined as unknown as HomebrewPowerPackContent;
